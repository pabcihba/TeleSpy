...
- [ ] Команда .note для быстрых заметок в Избранное
- [ ] Мониторинг онлайн пользователя , импорт в виде графика
- [ ] Команда .help для вывода всех возможных команд в Избранное
